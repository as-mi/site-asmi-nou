...
### ASP.NET 5
- ASP.NET 5 are nevoie sa fie instalate pe Visual Studio urmatoarele:
...
*Daca nu il ai deja descarcat local*
...
*Daca il ai deja descarcat local*
...
### :toolbox: Creare branch nou si incarcare modificari pe Git-ul ASMI
1. Deschide folderul rezultat in urma clonarii ```site-asmi-nou```.
2. Deschide Git Bash in el.
